...
---
A kata is to a developer what scales are to a musician: a short, repeated
exercise that builds reflexes — write the test first, refactor without fear,
name with care. These are on my GitHub, among others.
